...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   기본 자료형 대이터를 인스턴스화 해야하는 경우들이 발생한다.
        ...
        * */
        ...
        /* 필기.
        *   박싱(Boxing) 언박식(unBoxing)
        *   기본타입을 래퍼클래스의 인스턴스로 인스턴스화 하는것을 Boxing 이라고 하며,
        ...
        *  */
        ...
        int unBoxingNumber1 = boxingNumber1.intValue();// intValue() 이용 (언박싱)
        ...
        /* 필기. valueOf() 를 이용하여 인스턴스를 생성하는 거슬 권장한다,
