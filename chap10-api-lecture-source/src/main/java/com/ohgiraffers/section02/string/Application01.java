...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        System.out.println("comlareTo() : "+ (str2.compareTo(str3)));
        System.out.println("comlareTo() : "+ (str2.compareTo(str4)));
        System.out.println("comlareTo() : "+ (str4.compareTo(str2)));
        ...
        /* 필기. toLowerCase() : 모든 문자를 소문자로 변환 */
        String caseStr = "JavaOracle";
        System.out.println("toLowCase() : "+ caseStr.toLowerCase());

        /* 필기. replace() : 문자열에서 대체할 문자열로 기존 문자열을 변경해서 반환  */
        String javaoracle = "javaoracle";

        System.out.println("replce() : "+javaoracle.replace("java","python"));
