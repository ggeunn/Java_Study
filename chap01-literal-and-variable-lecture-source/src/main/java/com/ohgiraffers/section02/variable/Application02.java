...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기.
        *   자료형이란?
        *   다양한 값의 형태로 어느 정도의 크기를 하나의 값으로 취급할 것인지 미리 compiler 와 약속한 키워드이다.
        ...
        *       그 중 기본자료형 8가지부터 살펴보자.*/
        ...
        /* 필기. 이상 8가지 기본자료형(primary type)이라고 한다. */
        ...
        snum = 2;
        inum = 4;
        lnum = 8L;       // 아무 문제 없는 것 같지만 사실뒤에 대문자 L을 붙여야한다. 그 이유는 뒤에 형변환에서 다루게 될 것이다.

        /* 목차. 2-2. 실수를 취급하는 자료형에 값 대입 */
        fnuum = 4.0f;   // 실수 형태의 값에 f를 붙인다.
        dnum = 8.0;
