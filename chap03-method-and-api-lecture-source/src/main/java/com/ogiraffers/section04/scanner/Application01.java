...
//        java.util.Scanner sc = new Scanner(System.in);
       ...
       /* 목차. 1-2. 다른 패키지에 있는 클래스 사용 시 생략하기 위해 import를 사용. */
        ...
        System.out.println("참과 거짓 둘 중 한 가지를 true or false 로 입력해주세요 : ");
        ...
        System.out.println("두번째 글자는 "+ch+" 입니다.");
