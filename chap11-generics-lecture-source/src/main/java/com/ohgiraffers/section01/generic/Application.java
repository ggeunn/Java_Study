...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *
        * 필기.
        *  제네릭은 클래스나 메소드에서 사용할 재부 데이터타입을 컴파일 시에 지정하는 방법을 말한다.
        *  컴파일 시에 미리 타입거사를 시행하게 되면 클래스나 메소드 내부에서 사용되는 객체의 타입
        *  안정성을 높일 수 있으며, (잘못 된 타입인 경우 컴파일 에러를 발생시킴 )
        *  반환값에 대한 타입 변환 및 타입 검사에 들어가는 코드 생략이 가능해진다
        *  (instanceof 비교 및 다운캐스팅 작성 불필요)
        *
        * 필기.
        *  제네릭 프로그래밍
        *  데이터의 셩식에 의존하지 않고 하나의 값이 여러 다른데이터 타입들을 가질 수 있는 기술에
