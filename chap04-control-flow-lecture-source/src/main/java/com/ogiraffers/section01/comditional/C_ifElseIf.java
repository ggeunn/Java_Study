...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseIfStatement(){
        ...
        /* 수업목표. if-eles-if 문 단독 사용에 대한 흐름을 이해하고 적용할 수 있다.  */
        ...
        * */
        ...
        /* 필기.
        *   if-else-if 문은 조건식1의 결과 값이 참(true) 이면 if {} 안에 있는 코드 실행.
        *   조건식1이 false 이면 조건식2를 확인하여 참(true)이면 else if {} 안에 있는
        *   코드를 실행한다.
        ...
        * */
        ...
        System.out.println("나무꾼이 어쩔 줄 몰라하던 그 떄 ...");
        ...
        if(answer == 1 ){
            ...
            System.out.println("이런 거짓말쟁이 너에겐 아무 도끼를 줄 수 없음");

        }else if(answer == 2 ){

            System.out.println("욕심이 과하지는 않지만 그래도 넌 거짓말했음 ");

        }else if(answer == 3) {
            System.out.println("오 ~ 정직한 놈임");
        }else {
