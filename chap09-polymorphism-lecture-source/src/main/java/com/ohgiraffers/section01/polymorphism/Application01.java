...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   다형성
        *   하나의 인스턴스가 여러가지 타입을 가질 수 있는 것을 말한다.
        *   하나의 타입으로 여러 타입의 인스턴스를 처리할수도 있기도 하고,
        *   하나의 메소드 호출로 객체별로 각기 다른 방법으로 동작할 수 있다.
        *   객체지향 프로그래밍 3대 특징(캡슐화, 상속, 다형성) 중 하나
        *  */

       /* 필기.
       *   다형성 장점
       *    1. 여러타입의 객체를 하나의 타입으로 관리할 수 있기 댸문에 유지보수성과 생산성이 증가
       ...
       *  */
        ...
        *   따라서 토끼는 토끼타입이기도 하면서 동물타입이다.
        *   호랑이도 마찬가지로 호랑이 타팁이기도 하면서 동물 타입이다.
        *  */

        /* 목차. 5. 부모타입(동물) 으로 자식 인스턴스(호랑이, 토끼) 주소값 저장  */
...
//        호랑이 t1 = new 동물();
        ...
        *       토끼와 호랑이가 가지고 있는 고유한 기능은 동작 시키지 못한다.
        *  */
//        a1.점프();
//        a2.물어뜯기();
...
//        ((호랑이)a1).물어뜯기();  토끼는 호랑이가 될 수 없다. RuntimeException 번역은 문제가 없지만, 프로그램 동작 시 오류 발생
        ...
        /* 필기. 레퍼런스 변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비교하는 연산자  */
        System.out.println("=======instanceof 확인=======");
        System.out.println("a1 이 호랑이 타입인지 확인 : "+(a1 instanceof 호랑이));
        System.out.println("a1 이 토끼 타입인지 확인 : "+(a1 instanceof 토끼));
        System.out.println("a1 이 동물 타입인지 확인 : "+(a1 instanceof 동물));
        ...
        * */
        ...
        동물 a4 = new 토끼();        // up-casting 명시적 형변환

//        토끼 r3 = a3;               // down-casting 묵시적 형변환은 안됨
        토끼 r4 = (토끼)a3;            // down-casting 묵시적 형변환
