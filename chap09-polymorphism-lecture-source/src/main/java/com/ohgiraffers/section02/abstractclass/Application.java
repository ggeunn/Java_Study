...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   추상클래스돠 추상메소드
        *   추상메소드를 0개이상 포함하는 클래스를 추상클래스라고 한다
        ...
        *  메소드는 다형성이 적용되어 동적 바인딩에 의 다향한 응답을 할 수 있다.
        *
        * 필기.
        ...
        * 필기.
        *  추상메소드랑?
        *  메소드의 선언부만 있고 구현부 ( {} ) 가 없는 메소드를 추상메소드라고 한다.
...
//        Product product = new Product();
        ...
        *   따라서 여러 클래스들을 그룹화하여 추상메소드로 필수기능 정의를 해두고 추상메소드에 강제성을 부여해
        *   개발 시 일관 되게 만들 수 있다.  */
