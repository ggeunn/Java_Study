...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기. 값을 넣을 떄는 push() 메소드를 이용한다. add() 도 가능 */
        integerStack.push(1);
        integerStack.push(2);
        integerStack.push(3);
        integerStack.push(4);
        ...
        /* 필기.
        *   Stack 에서 요소를 찾을 떄 search() 를 이용할 수 있다.
        *   인덱스가 아닌 위에서 부터의 순번을 의미한다.
        *   또한 가장 산단의 위치가 0이 아닌 1부터 시작한다.
        *  */
        ...
        *   pop() : 해당 스택의 가장 마지막에 있는(상단) 요소 반환후 제거
        * */
