...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   자바에서 컬렌션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효과적으로 처리할 수 있도록
        *   표준화 된 방법을 제공하는 클래스들의 집합을 의미한다.
        *   즉, 데이터는 효율적으로 저장하는 자료구조와 데이터를 처리하는 알고리즘을 미리 구현해두었다.
        * */

        /* 필기.
        *   Collection Framework 는 크게 3가지 인터페이스 중 한가지를 상속받아 구현해두었다.
        *   1. List
        *   2. Set
        *   3. Map
        *
        ...
        *   - Vector, ArrayList, LinkedList, Stack, Queue 등 이있다.
        *   2. Set
        *   - 순서가 없는 데이터의 집합으로 데이터 중복을 허용하지 않는다.
        *   - HashSet, TreeSet 등이 있다.
        *   3. Map
        *   - 키와 값 한 쌍으로 이루어지는 데이터 집합이다.
        *   - key 와 Set 방식으로 관리하기 때문에 데이터의 순소를 관리하지 않고 , 중복된 key 를 허용하지 않는다.
        ...
        *  */
        ...
        List<String> stringList = new ArrayList<>();  //String 타입으로 제한
//        stringList.add(123);
        ...
        *   hasNext() : 다음요소를 가지고 있으면 true, 더 이상 요소가 없으면 false 를 반환
        *   next() : 다음 요소(값)를 반환
        *   */

        Iterator<String> dIter = ((LinkedList<String>)stringList).descendingIterator();

        /* 필기. 역숙으로 정렬 된 결과를 저장하기 위해 새로운 ArrayList 를 만들어서 저장 */
