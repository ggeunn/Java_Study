...
public class User {
    ...
    *   통상적으로 필드 선언부와 메소드 선언부ㅜ 사이에 적는 것이 관례이다.
    *  */
    ...
    *   2. 생성자 메소드는 반환형을 작성하지 않는다. (작성하는 경우 생성자가 아닌 일반메소드로 인식한다.)
    *    */
...
//        this.enrollDate = enrollDate;
        ...
        *   this() 는 가장 첫 줄에 선언해야하며, 그렇지 않는 경우 Compile Error 가 발생한다,
        *  */
        this(id, pwd, name);
        this.enrollDate = enrollDate;
