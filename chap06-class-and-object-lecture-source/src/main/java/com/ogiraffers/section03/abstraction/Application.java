...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   객체 지향 프로그래밍이란?
        *   형실세계의 모든 사건(event)는 객체와 객체의 상호작용에 의해 일어난다는 세계관
        ...
        *   현실 세게를 프로그램의 목적에 맞게 단순화하는 '추상화' 라는 기법을 적용하게 된다.
        *  */
        ...
        *  */
        ...
        /* 필기.
        *   객체와 객체의 상호작용이란?
        *   객체와 객체는 메세지를 통해 서로 상호작용을 한다. 메세지(메소드 호출)룰 보내는 쪽을 송신자
        *   메세지(메소드)를 수신하는 쪽을 수신자 라고 한다. 수신자는 메세지를 전달 받아 그 메세지에
        *   해당하는 내용을 처리하는 방법을 스스로 결정하고, 그 결정한 방법대로 처리할 명령어들을
        *   순차적으로 기술한 것을 메소드라고 한다.
        *   상호작용에 중요한 것은 메세지 송수신 하고 그 방법을 기술하여 메세지에 응답하는 상호작용을
        *   설계하는 것이다.
        *   따라서 객체를 설계할 때는 속성은 부가적이며, 적절한 책임을 가진 객체들 간 주고 받는 메세지를
        *   이용해 상호작용 하는 것을 설계하는것을 의미한다.
        *   즉, 필드 보다는 메소드를 중점으로 추상화 기법을 적용하여 객체를 설꼐하고,
        *   그 객체를 구현하는 방법으로 설계한 대로 클래스를 작성하는 것이다.
        * */

        /* 필기.
        *   프로그램 개요
        *   카레이서가 자동차를 운정하는 프로그램
        *  */

        /* 필기.
        *   시스템 요구사항
        *   1. 카레이서는 시동걸기, 엑셀레이터밟기, 브레이크밟기, 시동끄기를 할 수 있다.
        *   2. 자동차는 시동걸기, 앞으로가기, 멈추기, 시동끄기를 할 수 있다.
        *   3. 자동차는 처음에 멈춘 상태로 대기하고 있는다.
        *   4. 카레이서는 먼저 자동차에 시동을 건다. 이미 시동이 걸려 있으면 다시 시동을 걸 수 없다.
        *   5. 카레이서는 엑셀레이터를 밟으면 시동이 걸렸다면 자동차는 시속이 10km/h 증가하며 앞으로 나간다.
        *   6. 자동차가 달리는 중인 경우 브레이크를 밟으면 자동차의 시속은 0km/h로 된다.
