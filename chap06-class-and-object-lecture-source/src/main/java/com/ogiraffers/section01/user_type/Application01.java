...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        int age = 20;
        char gender = '여';
        String[] hobby = new String[] {"야구" , "배트민턴", "탁구"};
        ...
        *   2. 모든 회원 정보를 인자로 메소드 로출 시 값을 전달해야하면
        ...
        *  */
        ...
        /* 필기.
        *   이렇게 위에서 처럼 객체를 생성하고 나면, 서로 다른 자료형들은 하나의 member 라는 변수명으로
        *   관리할 수 있도록 공간을 생성한 것이다.
        *   heap 이라는 공간에 생성되기 때문에 jvm 이 제공하는 기본값들로 초기화 되다.
        *  */

        /* 필기.
        *   필드에 접근하기 위해서는 레퍼런스변수명.필드명 <- 이렇게 접근한다.
        *   '.' 참조연산자 라고 하는데, 레퍼런스 변수가 참조하고 있는 주소로 접근한다 라는 의미
        *   각 공간은 필드명으로 접근한다.
        *  */
