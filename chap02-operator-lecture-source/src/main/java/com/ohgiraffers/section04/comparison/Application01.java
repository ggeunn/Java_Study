...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   많이 사용된다는 것을 많이 연습해야 된다는 것이다.
        * */

        /* 필기.
        *   비교연산자의 종류
        *   '==' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 다르면 false를 반환
        *   '!=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 다르면 true 같으면 flase를 반환
        ...
        *  */
        ...
        System.out.println("inum1과 inum2가 같은 않은 지 비교 : "+ (inum1 != inum2));

        System.out.println("inum1이 inum2보다 큰 지 비교 : "+ (inum1 > inum2));
        System.out.println("inum1이 inum2가보다 크거나 같은 비교 : "+ (inum1 >= inum2));
        ...
        System.out.println("ch1과 ch2가 같은 않은 지 비교 : "+ (ch1 != ch2));

        System.out.println("ch1이 ch2보다 큰 지 비교 : "+ (ch1 > ch2));
        System.out.println("ch1이 ch2보다 크거나 같은 비교 : "+ (ch1 >= ch2));
        System.out.println("ch1이 ch2보다 작은 지 비교 : "+ (ch1 < ch2));
        System.out.println("ch1이 ch2보다 작거나 같은 지 비교 : "+ (ch1 <= ch2));
        ...
        System.out.println("bool1과 bool2가 같은 않은 지 비교 : "+ (bool1 != bool2));
        System.out.println("=====================================================================");
//        System.out.println("bool1이 bool2보다 큰 지 비교 : "+ (bool1 > bool2));
//        System.out.println("bool1이 bool2보다 크거나 같은 비교 : "+ (bool1 >= bool2));
...
//        System.out.println("str1이 str2보다 크거나 같은 비교 : "+ (str1 >= str2));
//        System.out.println("str1이 str2보다 작은 지 비교 : "+ (str1 < str2));
