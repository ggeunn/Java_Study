...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        *   논리식 || 논리식 : 앞의 결과과 true 이면 뒤를 실행 안 함.
        *  */

        /* 목차. 1. 논리식 && 논리식 : 앞의 결과과 false 이면 뒤를 실행 안함. */
        /* 필기.
        *   조선식 두 개가 모두 만족해야 true를 반환하지만, 앞에서 미리 false가 나오면
        *   뒤의 조선을 확인할 필요가 없이 false를 반환한다.
        ...
        *  */
        ...
        /* 필기.
        *   조건식 둘중 하나라도 true를 반환하면 true를 반환하기 때문에 앞에서 미리 true가
        *   나오게 되면 뒤의 조건을 확인 할 필요없이 true를 반환한다.
