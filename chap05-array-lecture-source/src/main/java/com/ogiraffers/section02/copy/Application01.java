...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   다른 래퍼런스 변수로 접근했을 때도 동일한 배열을 가리키고 있기 때문에 변경된 값이 반영 되어 있다.
        * */

        //원본 배열 생성
        int[] originArr = {1, 2, 3, 6, 5};

        //originArr 에 저장된 배열의 주소를 copyArr 에도 저장해보자
        int[] copyArr = originArr;  //얕은 복사

        System.out.println("originArr의 해시코드 : "+originArr.hashCode());
        System.out.println("copyArr의 해시코드 : "+copyArr.hashCode());
        ...
        for (int i = 0; i < originArr.length; i++) {
            ...
            System.out.println("수정된 값 :"+originArr[i]);
        ...
        for (int i = 0; i < copyArr.length; i++) {
            ...
            System.out.println("수정된 값 :"+copyArr[i]);
